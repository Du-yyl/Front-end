  ...
  <view class="page-body">
    ...
    <view class="uni-padding-wrap uni-common-mt">
      ...
      <movable-area scale-area>
        <movable-view :scale-value="scale" direction="all" scale scale-max="4" scale-min="0.5" @scale="onScale">text
        </movable-view>
      </movable-area>
      <view class="uni-link uni-center uni-common-mt" style="padding-bottom:80rpx;" @tap="tap2">
        点击这里放大3倍
      </view>
    </view>
  </view>
