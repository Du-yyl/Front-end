<template>
  <view class="page">
    ...
    <view class="feedback-body"><textarea v-model="sendDate.content" class="feedback-textare"
                                          placeholder="请详细描述你的问题和意见..."></textarea></view>
    <view class="feedback-title">
          ...
          <view class="uni-uploader__files">
            <block v-for="(image, index) in imageList" :key="index">
              <view class="uni-uploader__file" style="position: relative;">
                <image :src="image" class="uni-uploader__img" @tap="previewImage(index)"></image>
    ...
    <view class="feedback-body"><input v-model="sendDate.contact" class="feedback-input" placeholder="(选填,方便我们联系你 )"/>
    </view>
    ...
    <button class="feedback-submit" type="default" @tap="send">提交</button>
    <view class="feedback-title">
