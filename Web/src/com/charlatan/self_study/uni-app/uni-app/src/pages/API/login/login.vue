  ...
  <view>
    ...
    <view class="uni-padding-wrap">
      ...
      <view class="uni-btn-v uni- uni-common-mt">
        <!-- #ifdef MP-TOUTIAO  -->
        <button v-for="(value,key) in providerList" :key="key" class="page-body-button" type="primary"
                @click="tologin(value)">
          登录
        </button>
        <!-- #endif -->
        <!-- #ifndef MP-TOUTIAO -->
        <button v-for="(value,key) in providerList" :key="key"
                :loading="value.id === 'univerify' ? univerifyBtnLoading : false" class="page-body-button"
                type="primary" @click="tologin(value)">{{ value.name }}
        </button>
        <!-- #endif -->
      </view>
    </view>
