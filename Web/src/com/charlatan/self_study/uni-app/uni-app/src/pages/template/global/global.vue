<template>
  <view class="pa">
    ...
    <button class="button" @click="setGD()">修改上述值为123</button>
    ...
    <button class="button" @click="setVUEX(true)">修改上述值为true</button>
    <button class="button" @click="setVUEX(false)">修改上述值为false</button>
  </view>
</template>
