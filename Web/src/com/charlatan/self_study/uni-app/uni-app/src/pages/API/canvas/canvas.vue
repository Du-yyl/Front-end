<template>
  <view>
    ...
    <view class="uni-common-mt">
      <canvas id="canvas" canvas-id="canvas" class="canvas-element"></canvas>
      <scroll-view class="canvas-buttons" scroll-y="true">
        <block v-for="(name, index) in names" :key="index">
          <button class="canvas-button" @click="handleCanvasButton(name)">{{ name }}</button>
        </block>
        <button class="canvas-button" type="primary" @click="toTempFilePath">toTempFilePath</button>
      </scroll-view>
    </view>
  </view>
</template>
...
export default {
  data () {
    return {
      title: 'createContext',
      names: [
        'rotate', 'scale', 'reset', 'translate', 'save', 'restore', 'drawImage', 'fillText', 'fill',
