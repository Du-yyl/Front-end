<template>
  <view class="container">
    ...
    <uni-section subTitle="点击按钮,切换 fab 不同状态" title="基本功能" type="line">
      <view class="warp">
    ...
    <uni-fab ref="fab" :content="content" :direction="direction" :horizontal="horizontal" :pattern="pattern"
             :vertical="vertical" @fabClick="fabClick" @trigger="trigger"/>
  </view>
</template>
