  ...
  <view class="uni-swipe">
    ...
    <view :change:prop="wxsswipe.showWatch" :data-disabled="disabled"
      ...
      <view :change:prop="renderswipe.showWatch" :data-disabled="disabled+''"
            ...
            @touchend="renderswipe.touchend" @touchmove="renderswipe.touchmove" @touchstart="renderswipe.touchstart">
        <!-- #endif -->
        <!-- 在微信小程序 app vue端 h5 使用wxs 实现-->
        <view class="uni-swipe_button-group button-group--left">
          <slot name="left">
            <view v-for="(item,index) in leftOptions" :key="index" :style="{
                  ...
                  @touchstart="appTouchStart" @click.stop="onClickForPC(index,item,'left')">
              <text
