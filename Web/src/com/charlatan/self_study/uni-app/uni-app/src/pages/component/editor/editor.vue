    ...
    <view class="page-body">
      <view class='wrapper'>
        ...
        <view class="editor-wrapper">
          <editor id="editor" :read-only="readOnly" class="ql-container" placeholder="开始输入..." showImgResize showImgSize
                  showImgToolbar @ready="onEditorReady" @statuschange="onStatusChange">
          </editor>
        </view>
      </view>
    </view>
