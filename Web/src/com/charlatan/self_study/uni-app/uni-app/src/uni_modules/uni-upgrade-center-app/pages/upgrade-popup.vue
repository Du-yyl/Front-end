  ...
  <view class="mask flex-center">
    <view class="content botton-radius">
      <view class="content-top">
        ...
        <image class="content-top" height="100%" src="../images/bg_top.png" style="top: 0;" width="100%">
        </image>
      </view>
          ...
          <template v-else>
            <template v-if="!downloadSuccess">
              <view v-if="downloading" class="progress-box flex-column">
                <progress :percent="downLoadPercent" activeColor="#3DA7FF" border-radius="35"
                          class="progress" show-info stroke-width="10"/>
              ...
              <button v-else class="content-button" plain style="border: none;color: #fff;"
                      @click="downloadPackage">
                {{ downLoadBtnText }}
              </button>
            </template>
            <button v-else-if="downloadSuccess && !installed" :disabled="installing"
                    :loading="installing" class="content-button" plain style="border: none;color: #fff;"
                    @click="installPackage">
              {{ installing ? '正在安装……' : '下载完成，立即安装' }}
            </button>

            <button v-if="installed && isWGT" class="content-button" plain style="border: none;color: #fff;"
                    @click="restart">
              安装完毕，点击重启
            </button>
          </template>
