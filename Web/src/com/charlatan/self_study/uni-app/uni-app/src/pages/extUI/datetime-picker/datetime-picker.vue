<template>
  <view class="page container">
    ...
    <view class="example-body">
      <uni-datetime-picker v-model="single" :clear-icon="false" type="date" @maskClick="maskClick"/>
    </view>
    <uni-section :title="'日期时间用法：' + datetimesingle" type="line"></uni-section>
    <view class="example-body">
      <uni-datetime-picker v-model="datetimesingle" type="datetime" @change="changeLog"/>
    </view>
    ...
    <view class="example-body">
      <uni-datetime-picker v-model="datetimerange" rangeSeparator="至" type="datetimerange"/>
    </view>
    ...
    <view class="example-body">
      <uni-datetime-picker v-model="single" returnType="timestamp" @change="changeLog($event)"/>
    </view>
    <uni-section :title="'date 对象用法：' + datetimesingle" type="line"></uni-section>
    <view class="example-body">
      <uni-datetime-picker v-model="datetimesingle" returnType="date" type="datetime" @change="changeLog"/>
    </view>
