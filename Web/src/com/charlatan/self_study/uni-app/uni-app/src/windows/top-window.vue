  ...
  <view class="top-window-header">
    <view class="left-header logo">
      <navigator class="logo" open-type="reLaunch" url="/pages/component/view/view">
        <image mode="heightFix" src="../static/logo.png" style="width: 30px;"></image>
        <text>hello uni-app</text>
      </navigator>
    </view>
    <custom-tab-bar :selected="current" :show-icon="false" class="tab-bar-flex" direction="horizontal"
