  ...
  <view>
    ...
    <view class="uni-padding-wrap uni-common-mt">
      ...
      <view class="uni-btn-v">
        <button :disabled="disabled[0]" type="primary" @click="openBluetoothAdapter">
          初始化蓝牙模块
        </button>
        ...
        <button :disabled="disabled[4]" type="primary" @click="createBLEConnection">
          连接蓝牙设备
        </button>
        <button :disabled="disabled[5]" type="primary" @click="getBLEDeviceServices">
          选择设备服务
        </button>
        <view v-if="servicesData.length > 0">已选服务uuid：{{ servicesData[0].uuid }}</view>
        <button :disabled="disabled[6]" type="primary" @click="getBLEDeviceCharacteristics">
          获取服务的特征值
        </button>
        ...
        <button :disabled="disabled[9]" type="primary" @click="closeBLEConnection">
          断开蓝牙设备
        </button>
        <button :disabled="disabled[10]" type="primary" @click="closeBluetoothAdapter">
          关闭蓝牙模块
        </button>
      </view>
    </view>
    <!-- 遮罩 -->
    <view v-if="maskShow" class="uni-mask" @click="maskclose" @touchmove.stop.prevent="moveHandle">
