<template>
  <view :style="{backgroundImage:'url('+img+')'}" class="root">
    <view :class="[show ? 'up' : '','shake-up']">
      <image mode="aspectFit"
             src="https://vkceyugu.cdn.bspapp.com/VKCEYUGU-dc-site/b718cdb0-517d-11eb-a16f-5b3e54966275.png"></image>
    </view>
    <view :class="[show ? 'down' : '','shake-down']">
      <image mode="aspectFit"
             src="https://vkceyugu.cdn.bspapp.com/VKCEYUGU-dc-site/b6600500-517d-11eb-8ff1-d5dcf8779628.png"></image>
    </view>
  </view>
</template>
<script>
