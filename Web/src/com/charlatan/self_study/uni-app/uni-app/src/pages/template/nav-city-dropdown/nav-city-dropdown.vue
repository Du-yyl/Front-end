<template>
  <view class="mpvue-picker">
    ...
    <mpvue-picker ref="mpvuePicker" :deepLength="deepLength" :mode="mode" :pickerValueArray="pickerValueArray"
                  :pickerValueDefault="pickerValueDefault" :themeColor="themeColor" @onCancel="onCancel"
