  ...
  <view class="uni-date">
    ...
    <view v-if="!isPhone" v-show="popup" ref="datePicker" class="uni-date-picker__container">
      <view v-if="!isRange" :style="popover" class="uni-date-single--x">
        ...
        <calendar ref="pcSingle" :date="defSingleDate"
                  :end-date="caleRange.endDate" :showMonth="false" :start-date="caleRange.startDate"
                  style="padding: 0 8px;" @change="singleChange"/>
      ...
      <view v-else :style="popover" class="uni-date-range--x">
        ...
        <view class="popup-x-body">
          <calendar ref="left" :end-date="caleRange.endDate"
                    :pleStatus="endMultipleStatus" :range="true" :showMonth="false"
                    :start-date="caleRange.startDate" style="padding: 0 8px;" @change="leftChange"
                    @firstEnterCale="updateRightCale" @monthSwitch="leftMonthSwitch"/>
          <calendar ref="right" :end-date="caleRange.endDate"
                    :pleStatus="startMultipleStatus" :range="true" :showMonth="false"
                    :start-date="caleRange.startDate" style="padding: 0 8px;border-left: 1px solid #F1F1F1;"
                    @change="rightChange"
