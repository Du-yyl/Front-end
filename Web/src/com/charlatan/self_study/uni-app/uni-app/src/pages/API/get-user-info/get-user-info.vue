      ...
      <view style="background:#FFF; padding:40rpx;">
        ...
        <block v-if="hasUserInfo === true">
          ...
          <view v-if="userInfo.avatarUrl || userInfo.avatar_url " style="padding:30rpx 0; text-align:center;">
            <image :src="userInfo.avatarUrl||userInfo.avatar_url" class="userinfo-avatar"></image>
          </view>
        </block>
      </view>
      <view class="uni-btn-v">
        <!-- #ifdef APP-PLUS || MP-ALIPAY || MP-TOUTIAO -->
        <button :loading="btnLoading" type="primary" @click="getUserInfo">获取用户信息</button>
        <!-- #endif -->
        <!-- #ifdef MP-WEIXIN || MP-BAIDU || MP-QQ  || MP-JD -->
        <button open-type="getUserInfo" type="primary" @getuserinfo="mpGetUserInfo">获取用户信息</button>
        <!-- #endif -->
