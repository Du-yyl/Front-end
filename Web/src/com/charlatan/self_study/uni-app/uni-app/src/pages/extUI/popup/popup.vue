<template>
  <view class="container">
    ...
    <uni-section class="hideOnPc" title="对话框示例" type="line">
      <view class="example-body box">
    ...
    <uni-section padding title="输入框示例" type="line">
    ...
    <uni-section padding title="底部分享示例" type="line">
    ...
    <view>
      ...
      <uni-popup ref="message" type="message">
        <uni-popup-message :duration="2000" :message="messageText" :type="msgType"></uni-popup-message>
      </uni-popup>
    </view>
    ...
    <view>
      ...
      <uni-popup ref="alertDialog" type="dialog">
        <uni-popup-dialog :type="msgType" cancelText="关闭" confirmText="同意" content="欢迎使用 uni-popup!" title="通知"
                          @close="dialogClose"
    ...
    <view>
      ...
      <uni-popup ref="inputDialog" type="dialog">
        <uni-popup-dialog ref="inputClose" mode="input" placeholder="请输入内容" title="输入内容"
                          value="对话框预置提示内容!" @confirm="dialogInputConfirm"></uni-popup-dialog>
      </uni-popup>
    </view>

    <view>
      <!-- 分享示例 -->
      <uni-popup ref="share" backgroundColor="#fff" safeArea type="share">
