    ...
    <view class="uni-common-mt">
      <view class="uni-list">
        <view class="uni-list-cell">
          ...
          <view class="uni-list-cell-db">
            <input :value="name" class="uni-input" name="name" placeholder="请输入联系人名称" type="text" @input="nameChange"/>
          </view>
        </view>
        <view class="uni-list-cell">
          <view class="uni-list-cell-left">
          ...
          <view class="uni-list-cell-db">
            <input :value="phone" class="uni-input" name="phone" placeholder="请输入联系人手机号" type="text"
                   @input="phoneChange"/>
          </view>
        </view>
      </view>
      <view class="uni-padding-wrap">
        <view class="uni-btn-v">
          <button class="btn-setstorage" type="primary" @tap="add">添加联系人</button>
        </view>
      </view>
    </view>
  </view>
