        ...
        <view class="uni-list">
          <view class="uni-list-cell">
            ...
            <view class="uni-list-cell-right">
              <picker :range="sourceType" :value="sourceTypeIndex" mode="selector" @change="sourceTypeChange">
          ...
          <view class="uni-list-cell">
            ...
            <view class="uni-list-cell-right">
              <picker :range="sizeType" :value="sizeTypeIndex" mode="selector" @change="sizeTypeChange">
          ...
          <view class="uni-list-cell">
            ...
            <view class="uni-list-cell-right">
              <picker :range="count" mode="selector" @change="countChange">
                ...
                <view class="uni-uploader__files">
                  <block v-for="(image,index) in imageList" :key="index">
                    <view class="uni-uploader__file">
                      <image :data-src="image" :src="image" class="uni-uploader__img" @tap="previewImage"></image>
                    </view>
                  </block>
