<template>
  <div class="mpvue-picker">
    ...
    <div :class="{'mpvue-picker-view-show':showPicker}" class="mpvue-picker-content ">
      <div catchtouchmove="true" class="mpvue-picker__hd">
        <div class="mpvue-picker__action" @click="pickerCancel">取消</div>
        <div :style="{color:themeColor}" class="mpvue-picker__action" @click="pickerConfirm">确定</div>
      </div>
      <picker-view :value="pickerValue" class="mpvue-picker-view" indicator-style="height: 40px;"
                   @change="pickerChange">
        <block>
          <picker-view-column>
            <div v-for="(item,index) in provinceDataList" :key="index" class="picker-item">{{ item.label }}</div>
          </picker-view-column>
          <picker-view-column>
