  ...
  <view>
    ...
    <uni-list>
      <template v-for="(item,index) in listData">
        ...
        <ad v-if="(index > 0 && (index+1) % 10 == 0)" adpid="1111111111" apid="" appid="" type="feed" unit-id=""></ad>
        <uni-list-item v-else :note="item.author_name" :thumb="item.cover" :title="item.title" thumb-size="lg"/>
      </template>
    </uni-list>
  </view>
</template>
