  ...
  <view>
      ...
      <view class="uni-list">
        <view class="uni-list-cell">
          ...
          <view class="uni-list-cell-right">
            <picker :range="sourceType" :value="sourceTypeIndex" @change="sourceTypeChange">
    ...
    <view class="uni-list">
      <radio-group @change="radioChange">
        <label v-for="(item, index) in cameraList" :key="item.value" class="uni-list-cell uni-list-cell-pd">
          <radio :checked="index === cameraIndex" :value="item.value">{{ item.name }}</radio>
        </label>
      </radio-group>
    </view>
    <!-- #endif -->
