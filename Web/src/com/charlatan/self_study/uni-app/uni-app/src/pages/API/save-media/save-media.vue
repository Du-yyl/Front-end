  ...
  <view>
    ...
    <view class="uni-padding-wrap">
      <view v-if="imagePath !== ''" class="media-box image">
        <image :src="imagePath" class="image" mode="widthFix"/>
      </view>
      <button class="uni-button" type="primary" @click="saveImage">拍摄图片并保存到本地</button>
      ...
      <button class="uni-button" type="primary" @click="saveVideo">录制视频并保存到本地</button>
    </view>
  </view>
</template>
<script>
