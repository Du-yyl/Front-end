  ...
  <view>
    ...
    <uni-section title="基础用法" type="line">
      <uni-collapse ref="collapse" v-model="value" @change="change">
        ...
        <uni-collapse-item disabled title="禁用状态">
          <view class="content">
    ...
    <uni-section title="使用动画效果" type="line">
      <uni-collapse>
        <uni-collapse-item :show-animation="true" title="使用动画">
          <view class="content">
            <text class="text">默认开启组件动画，使用动画效果折叠内容会有一个从上到下的动画。</text>
          </view>
        </uni-collapse-item>
        <uni-collapse-item :show-animation="false" title="不使用动画">
          <view class="content">
      ...
      <uni-collapse>
        <uni-collapse-item titleBorder="none">
          <template v-slot:title>
            <uni-list>
              <uni-list-item :extra-icon="extraIcon" :show-extra-icon="true" title="标题使用自定义标题插槽">
              </uni-list-item>
            </uni-list>
          </template>
          <view class="content">
        ...
        <uni-collapse-item title="折叠内容使用 uni-list 组件">
          <uni-list>
            ...
            <uni-list-item :disabled="true" note="列表禁用状态" title="列表文字"></uni-list-item>
            <uni-list-item :show-switch="true" title="列表右侧显示 switch"></uni-list-item>
            <uni-list-item :extra-icon="extraIcon" :show-extra-icon="true" title="列表左侧带扩展图标"></uni-list-item>
            <uni-list-item note="列表描述信息" rightText="右侧文字"
                           showArrow
                           thumb="https://vkceyugu.cdn.bspapp.com/VKCEYUGU-dc-site/460d46d0-4fcc-11eb-8ff1-d5dcf8779628.png"
                           thumb-size="lg" title="列表左侧带略缩图"></uni-list-item>
            <uni-list-item clickable showArrow title="开启点击反馈" @click="onClick"></uni-list-item>
          </uni-list>
        </uni-collapse-item>
      </uni-collapse>
    </uni-section>
