  ...
  <view>
    ...
    <view class="uni-list">
      <view class="uni-list-cell">
        ...
        <view class="uni-list-cell-db">
          <picker :range="multiArray" :value="multiIndex" mode="multiSelector"
    ...
    <view class="uni-list">
      <view class="uni-list-cell">
        ...
        <view class="uni-list-cell-db">
          <picker :value="time" end="21:01" mode="time" start="09:01" @change="bindTimeChange">
    ...
    <view class="uni-list">
      <view class="uni-list-cell">
        ...
        <view class="uni-list-cell-db">
          <picker :end="endDate" :start="startDate" :value="date" mode="date" @change="bindDateChange">
