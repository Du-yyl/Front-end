    ...
    <view class="uni-common-mt">
      <view class="uni-form-item uni-column">
        ...
        <checkbox-group class="uni-list" @change="checkboxChange">
          <label v-for="item in checkboxItems" :key="item.name" class="uni-list-cell uni-list-cell-pd">
            <view>
      ...
      <view class="uni-form-item uni-column">
        ...
        <radio-group class="uni-list" @change="radioChange">
          <view v-for="(item,index) in radioItems" :key="index" class="uni-list-cell uni-list-cell-pd">
            <view>
              <radio :id="item.name" :checked="item.checked" :value="item.name"></radio>
            </view>
            <label :for="item.name" class="label-2-text">
