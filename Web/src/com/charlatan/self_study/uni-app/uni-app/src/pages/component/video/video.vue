<template>
  <view>
    ...
    <view v-if="showVideo" class="uni-padding-wrap uni-common-mt">
      <view>
        <video id="myVideo"
               :danmu-list="danmuList"
               controls danmu-btn enable-danmu
      ...
      <view class="uni-list uni-common-mt">
        <view class="uni-list-cell">
          ...
          <view class="uni-list-cell-db">
            <input v-model="danmuValue" class="uni-input" placeholder="在此处输入弹幕内容" type="text"/>
          </view>
        </view>
      </view>
      <view class="uni-btn-v">
        <button class="page-body-button" @click="sendDanmu">发送弹幕</button>
      </view>
      <!-- #endif -->
    </view>
  </view>
