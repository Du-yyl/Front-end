<template>
  <view>
    ...
    <view class="uni-padding-wrap uni-common-mt">
      <button v-if="!loadError" :disabled="loading" :loading="loading" class="btn" type="primary" @click="show">显示广告
      </button>
      <button v-if="loadError" :disabled="loading" :loading="loading" class="btn" type="primary" @click="reloadAd">
        重新加载广告
      </button>
    </view>
    <!-- #ifndef APP-PLUS -->
