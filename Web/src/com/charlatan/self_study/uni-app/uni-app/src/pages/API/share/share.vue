  ...
  <view>
    ...
    <view class="uni-padding-wrap">
      ...
      <view class="uni-textarea">
        <textarea v-model="shareText" class="textarea"/>
      </view>
      <view class="uni-title">分享图片：</view>
      <view class="uni-uploader" style="padding:15rpx; background:#FFF;">
        <view v-if="!image" class="uni-uploader__input-box" @tap="chooseImage"></view>
        <image v-if="image" :src="image" class="uni-uploader__img"></image>
      </view>
      <!-- #ifdef APP-PLUS -->
      ...
      <view v-if="providerList.length > 0" class="uni-btn-v uni-common-mt">
        <block v-for="(value,index) in providerList" :key="index">
          <button v-if="value" :disabled="isDisableButton(value)" type="primary" @tap="share(value)">{{ value.name }}
          </button>
        </block>
      </view>
      <!-- #endif -->
