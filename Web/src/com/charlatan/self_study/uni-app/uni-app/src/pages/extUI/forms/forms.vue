<template>
  <view class="container">
      ...
      <view class="example">
        ...
        <uni-forms ref="baseForm" :modelValue="baseFormData">
          ...
          <uni-forms-item label="兴趣爱好" required>
            <uni-data-checkbox v-model="baseFormData.hobby" :localdata="hobbys" multiple/>
          </uni-forms-item>
          <uni-forms-item label="自我介绍">
            <uni-easyinput v-model="baseFormData.introduction" placeholder="请输入自我介绍" type="textarea"/>
          </uni-forms-item>
          <uni-forms-item label="日期时间">
            <uni-datetime-picker v-model="baseFormData.datetimesingle" return-type="timestamp"
                                 type="datetime"/>
          </uni-forms-item>
        </uni-forms>
      </view>
    ...
    <uni-section title="对齐方式" type="line">
      <view class="example">
        <view class="segmented-control">
          <uni-segmented-control :current="current" :values="items" styleType="button"
                                 @clickItem="onClickItem">
          </uni-segmented-control>
        </view>
        <!-- 展示不同的排列方式 -->
        <uni-forms ref="baseForm" :label-position="alignment" :modelValue="alignmentFormData">
          <uni-forms-item label="姓名" required>
            <uni-easyinput v-model="baseFormData.name" placeholder="请输入姓名"/>
          </uni-forms-item>
          <uni-forms-item label="年龄" required>
      ...
      <view class="example">
        ...
        <uni-forms ref="valiForm" :modelValue="valiFormData" :rules="rules">
          ...
          <uni-forms-item label="自我介绍" name="introduction">
            <uni-easyinput v-model="valiFormData.introduction" placeholder="请输入自我介绍" type="textarea"/>
          </uni-forms-item>
        </uni-forms>
    ...
    <uni-section title="自定义校验规则" type="line">
      <view class="example">
        <!-- 自定义表单校验 -->
        <uni-forms ref="customForm" :modelValue="customFormData" :rules="customRules">
          <uni-forms-item label="姓名" name="name" required>
          ...
          <uni-forms-item label="兴趣爱好" name="hobby" required>
            <uni-data-checkbox v-model="customFormData.hobby" :localdata="hobbys" multiple/>
          </uni-forms-item>
        </uni-forms>
      ...
      <view class="example">
        ...
        <uni-forms ref="dynamicForm" :modelValue="dynamicFormData" :rules="dynamicRules">
          ...
          <uni-forms-item v-for="(item,index) in dynamicLists" :key="item.id" :label="item.label+' '+index"
                          :name="'domains[' + item.id + ']'" :rules="item.rules" required>
        ...
        <view class="button-group">
          <button size="mini" type="primary" @click="add">新增域名</button>
          <button size="mini" type="primary" @click="submit('dynamicForm')">提交</button>
        </view>
      </view>
    </uni-section>
  </view>
