<template>
  <view class="qiun-columns">
    ...
    <view class="qiun-charts" style="background-color: #E5FDC3;">
      <!--#ifdef MP-ALIPAY -->
      <canvas id="canvasColumn" :height="cHeight*pixelRatio" :style="{'width':cWidth+'px','height':cHeight+'px'}"
              :width="cWidth*pixelRatio"
              canvas-id="canvasColumn"
              class="charts" style="background-color: #E5FDC3;"
              @touchstart="touchIt($event,'canvasColumn')"></canvas>
      <!--#endif-->
      <!--#ifndef MP-ALIPAY -->
      <canvas id="canvasColumn" canvas-id="canvasColumn" class="charts" style="background-color: #E5FDC3;"
              @touchstart="touchIt($event,'canvasColumn')"></canvas>
      <!--#endif-->
    </view>
    ...
    <view class="qiun-charts">
      <!--#ifdef MP-ALIPAY -->
      <canvas id="canvasColumnMeter" :height="cHeight*pixelRatio" :style="{'width':cWidth+'px','height':cHeight+'px'}"
              :width="cWidth*pixelRatio"
              canvas-id="canvasColumnMeter"
              class="charts"
              @touchstart="touchIt($event,'canvasColumnMeter')"></canvas>
      <!--#endif-->
      <!--#ifndef MP-ALIPAY -->
      <canvas id="canvasColumnMeter" canvas-id="canvasColumnMeter" class="charts"
              @touchstart="touchIt($event,'canvasColumnMeter')"></canvas>
      <!--#endif-->
    </view>
    <view class="qiun-bg-white qiun-title-bar qiun-common-mt">
    ...
    <view class="qiun-charts">
      <!--#ifdef MP-ALIPAY -->
      <canvas id="canvasMix" :height="cHeight*pixelRatio" :style="{'width':cWidth+'px','height':cHeight+'px'}"
              :width="cWidth*pixelRatio"
              canvas-id="canvasMix"
              class="charts" disable-scroll=true @touchend="touchEndMix"
              @touchmove="moveMix"
              @touchstart="touchMix"></canvas>
      <!--#endif-->
      <!--#ifndef MP-ALIPAY -->
      <canvas id="canvasMix" canvas-id="canvasMix" class="charts" disable-scroll=true @touchend="touchEndMix"
              @touchmove="moveMix"
              @touchstart="touchMix"></canvas>
      <!--#endif-->
    </view>
    ...
    <view class="qiun-charts">
      <!--#ifdef MP-ALIPAY -->
      <canvas id="canvasCandle" :height="cHeight*pixelRatio" :style="{'width':cWidth+'px','height':cHeight+'px'}"
              :width="cWidth*pixelRatio"
              canvas-id="canvasCandle"
              class="charts" disable-scroll=true @touchend="touchEndCandle"
              @touchmove="moveCandle"
              @touchstart="touchCandle"></canvas>
      <!-- 使用图表拖拽功能时，建议给canvas增加disable-scroll=true属性，在拖拽时禁止屏幕滚动 -->
      <!--#endif-->
      <!--#ifndef MP-ALIPAY -->
      <canvas id="canvasCandle" canvas-id="canvasCandle" class="charts" disable-scroll=true @touchend="touchEndCandle"
              @touchmove="moveCandle" @touchstart="touchCandle"></canvas>
      <!-- 使用图表拖拽功能时，建议给canvas增加disable-scroll=true属性，在拖拽时禁止屏幕滚动 -->
      <!--#endif-->
    </view>
    <view class="qiun-padding">
    ...
    <view class="qiun-charts">
      <!--#ifdef MP-ALIPAY -->
      <canvas id="canvasGauge" :height="cHeight*pixelRatio" :style="{'width':cWidth+'px','height':cHeight+'px'}"
              :width="cWidth*pixelRatio"
    ...
    <view class="qiun-charts3">
      ...
      <canvas id="canvasArcbar1"
              :style="{'width':cWidth3*pixelRatio+'px','height':cHeight3*pixelRatio+'px', 'transform': 'scale('+(1/pixelRatio)+')','margin-left':-cWidth3*(pixelRatio-1)/2+'px','margin-top':-cHeight3*(pixelRatio-1)/2+'px'}"
              canvas-id="canvasArcbar1"
              class="charts3"></canvas>
      <canvas id="canvasArcbar2"
              :style="{'width':cWidth3*pixelRatio+'px','height':cHeight3*pixelRatio+'px', 'transform': 'scale('+(1/pixelRatio)+')','margin-left':cWidth3-cWidth3*(pixelRatio-1)/2+'px','margin-top':-cHeight3*(pixelRatio-1)/2+'px'}"
              canvas-id="canvasArcbar2"
              class="charts3"></canvas>
      <canvas id="canvasArcbar3"
              :style="{'width':cWidth3*pixelRatio+'px','height':cHeight3*pixelRatio+'px', 'transform': 'scale('+(1/pixelRatio)+')','margin-left':cWidth3*2-cWidth3*(pixelRatio-1)/2+'px','margin-top':-cHeight3*(pixelRatio-1)/2+'px'}"
              canvas-id="canvasArcbar3"
              class="charts3"></canvas>
      <!--#endif-->
      <!--#ifndef MP-ALIPAY -->
      <canvas id="canvasArcbar1" canvas-id="canvasArcbar1" class="charts3"></canvas>
      <canvas id="canvasArcbar2" canvas-id="canvasArcbar2" class="charts3" style="margin-left: 250rpx;"></canvas>
      <canvas id="canvasArcbar3" canvas-id="canvasArcbar3" class="charts3" style="margin-left: 500rpx;"></canvas>
      <!--#endif-->
    </view>
    <view class="qiun-bg-white qiun-title-bar qiun-common-mt">
    ...
    <view class="qiun-charts">
      <!--#ifdef MP-ALIPAY -->
      <canvas id="canvasFunnel" :height="cHeight*pixelRatio" :style="{'width':cWidth+'px','height':cHeight+'px'}"
              :width="cWidth*pixelRatio"
              canvas-id="canvasFunnel"
              class="charts"
              @touchstart="touchPie($event,'canvasFunnel')"></canvas>
      <!--#endif-->
      <!--#ifndef MP-ALIPAY -->
      <canvas id="canvasFunnel" canvas-id="canvasFunnel" class="charts"
              @touchstart="touchPie($event,'canvasFunnel')"></canvas>
      <!--#endif-->
    </view>
    <view class="qiun-bg-white qiun-title-bar qiun-common-mt">
    ...
    <view class="qiun-charts">
      <!--#ifdef MP-ALIPAY -->
      <canvas id="canvasLineA" :height="cHeight*pixelRatio" :style="{'width':cWidth+'px','height':cHeight+'px'}"
              :width="cWidth*pixelRatio"
              canvas-id="canvasLineA"
              class="charts" disable-scroll=true @touchend="touchEndLineA"
              @touchmove="moveLineA"
              @touchstart="touchLineA"></canvas>
      <!-- 使用图表拖拽功能时，建议给canvas增加disable-scroll=true属性，在拖拽时禁止屏幕滚动 -->
      <!--#endif-->
      <!--#ifndef MP-ALIPAY -->
      <canvas id="canvasLineA" canvas-id="canvasLineA" class="charts" disable-scroll=true @touchend="touchEndLineA"
    ...
    <view class="qiun-charts-rotate">
      ...
      <canvas id="canvasLineB"
              :style="{'width':cWidth2*pixelRatio+'px','height':cHeight2*pixelRatio+'px', 'transform': 'scale('+(1/pixelRatio)+')','margin-left':-cWidth2*(pixelRatio-1)/2+'px','margin-top':-cHeight2*(pixelRatio-1)/2+'px'}"
              canvas-id="canvasLineB"
              class="charts-rotate"
              @touchstart="touchIt($event,'canvasLineB')"></canvas>
      <!--#endif-->
      <!--#ifndef MP-ALIPAY -->
      <canvas id="canvasLineB" canvas-id="canvasLineB" class="charts-rotate"
              @touchstart="touchIt($event,'canvasLineB')"></canvas>
      <!--#endif-->
    </view>
    <view class="qiun-bg-white qiun-title-bar qiun-common-mt">
    ...
    <view class="qiun-charts">
      <!--#ifdef MP-ALIPAY -->
      <canvas id="canvasArea" :height="cHeight*pixelRatio" :style="{'width':cWidth+'px','height':cHeight+'px'}"
              :width="cWidth*pixelRatio"
              canvas-id="canvasArea"
              class="charts" @touchstart="touchIt($event,'canvasArea')"></canvas>
      <!--#endif-->
      <!--#ifndef MP-ALIPAY -->
      <canvas id="canvasArea" canvas-id="canvasArea" class="charts" @touchstart="touchIt($event,'canvasArea')"></canvas>
      <!--#endif-->
    </view>
    <view class="qiun-bg-white qiun-title-bar qiun-common-mt">
    ...
    <view class="qiun-charts">
      <!--#ifdef MP-ALIPAY -->
      <canvas id="canvasPie" :height="cHeight*pixelRatio" :style="{'width':cWidth+'px','height':cHeight+'px'}"
              :width="cWidth*pixelRatio"
              canvas-id="canvasPie"
              class="charts" @touchstart="touchPie($event,'canvasPie')"></canvas>
      <!--#endif-->
      <!--#ifndef MP-ALIPAY -->
      <canvas id="canvasPie" canvas-id="canvasPie" class="charts" @touchstart="touchPie($event,'canvasPie')"></canvas>
      <!--#endif-->
    </view>
    <view class="qiun-bg-white qiun-title-bar qiun-common-mt">
    ...
    <view class="qiun-charts">
      <!--#ifdef MP-ALIPAY -->
      <canvas id="canvasRing" :height="cHeight*pixelRatio" :style="{'width':cWidth+'px','height':cHeight+'px'}"
              :width="cWidth*pixelRatio"
              canvas-id="canvasRing"
              class="charts" @touchstart="touchPie($event,'canvasRing')"></canvas>
      <!--#endif-->
      <!--#ifndef MP-ALIPAY -->
      <canvas id="canvasRing" canvas-id="canvasRing" class="charts"
              @touchstart="touchPie($event,'canvasRing')"></canvas>
      <!--#endif-->
    </view>
    <view class="qiun-bg-white qiun-title-bar qiun-common-mt">
    ...
    <view class="qiun-charts">
      <!--#ifdef MP-ALIPAY -->
      <canvas id="canvasRadar" :height="cHeight*pixelRatio" :style="{'width':cWidth+'px','height':cHeight+'px'}"
              :width="cWidth*pixelRatio"
              canvas-id="canvasRadar"
              class="charts"
              @touchstart="touchPie($event,'canvasRadar')"></canvas>
      <!--#endif-->
      <!--#ifndef MP-ALIPAY -->
      <canvas id="canvasRadar" canvas-id="canvasRadar" class="charts"
              @touchstart="touchPie($event,'canvasRadar')"></canvas>
      <!--#endif-->
    </view>
  </view>
...
.qiun-title-dot-light {
  border-left: 10 rpx solid #0ea391;
  padding-left: 10 rpx;
  font-size: 32 rpx;
  color: #000000
}
