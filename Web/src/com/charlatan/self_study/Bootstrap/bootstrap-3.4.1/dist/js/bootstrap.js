...
+function ($) {
  ...
  Tooltip.prototype.init = function (type, element, options) {
    ...
    this.$viewport = this.options.viewport && $(document).
      find($.isFunction(this.options.viewport)
  ...
  Tooltip.prototype.show = function () {
    ...
    if (this.hasContent() && this.enabled) {
      ...
      this.options.container ? $tip.appendTo($(document).find(this.options.container)) : $tip.insertAfter(
        this.$element)
...
+function ($) {
  ...
  var Affix = function (element, options) {
    ...
    this.$target = target.on('scroll.bs.affix.data-api', $.proxy(this.checkPosition, this)).
