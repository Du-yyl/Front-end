$(function () {
  ...
  QUnit.test('should set interval from data attribute', function (assert) {
    ...
    assert.strictEqual($carousel.data('bs.carousel').options.interval, false,
  ...
  QUnit.test('should support disabling the keyboard navigation', function (assert) {
    ...
    assert.strictEqual($template.find('.item')[0], $template.find('.active')[0],
  ...
  QUnit.test('should only add mouseenter and mouseleave listeners when not on mobile', function (assert) {
    ...
    $.each(['mouseover', 'mouseout'], function (i, type) {
      assert.strictEqual(type in $._data($template[0], 'events'), !isMobile,
  ...
  QUnit.test('should wrap around from start to end when wrap option is true', function (assert) {
    ...
    $carousel.on('slid.bs.carousel', function () {
      assert.strictEqual($carousel.find('.item.active').attr('id'), 'three',
  ...
  QUnit.test('should stay at the start when the prev method is called and wrap is false', function (assert) {
    ...
    assert.strictEqual($carousel.find('.item.active').attr('id'), 'one',
