$(function () {
  ...
  QUnit.test('should add aria-describedby to the trigger on show', function (assert) {
    ...
    var $trigger = $('<a href="#" rel="tooltip" title="Another tooltip"/>').appendTo('#qunit-fixture')

    $trigger.bootstrapTooltip().on('shown.bs.tooltip', function () {
  ...
  QUnit.test('should prefer title attribute over title option', function (assert) {
    ...
    $('<a href="#" rel="tooltip" title="Simple tooltip"/>').appendTo('#qunit-fixture').bootstrapTooltip({
  ...
  QUnit.test('should use title option', function (assert) {
    ...
    $('<a href="#" rel="tooltip"/>').appendTo('#qunit-fixture').bootstrapTooltip({
      title: 'This is a tooltip with some content',
    }).one('shown.bs.tooltip', function () {
  ...
  QUnit.test('should be placed dynamically to viewport with the dynamic placement option', function (assert) {
    ...
    function leftTooltip () {
      ...
      $leftTooltip.one('shown.bs.tooltip', function () {
    ...
    function rightTooltip () {
      ...
      $rightTooltip.one('shown.bs.tooltip', function () {
    ...
    $topTooltip.one('shown.bs.tooltip', function () {
  ...
  QUnit.test('should not misplace the tip when the right edge offset is greater or equal than the viewport width',
    function (assert) {
      assert.expect(2)
      var done = assert.async()
