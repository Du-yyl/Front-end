$(function () {
  ...
  QUnit.test('should insert into dom when show method is called', function (assert) {
    ...
    $('<div id="modal-test"/>').appendTo('#qunit-fixture').on('shown.bs.modal', function () {
  ...
  QUnit.test('should fire show event', function (assert) {
    ...
    $('<div id="modal-test"/>').appendTo('#qunit-fixture').on('show.bs.modal', function () {
  ...
  QUnit.test('should not fire shown when show was prevented', function (assert) {
    ...
    $('<div id="modal-test"/>').appendTo('#qunit-fixture').on('show.bs.modal', function (e) {
      e.preventDefault()
      assert.ok(true, 'show event fired')
      done()
  ...
  QUnit.test('should allow modal close with "backdrop:false"', function (assert) {
    ...
    $('<div id="modal-test" data-backdrop="false"/>').appendTo('#qunit-fixture').on('shown.bs.modal', function () {
      assert.ok($('#modal-test').is(':visible'), 'modal visible')
      $(this).bootstrapModal('hide')
    }).on('hidden.bs.modal', function () {
      assert.ok(!$('#modal-test').is(':visible'), 'modal hidden')
  ...
  QUnit.test('should add padding-right of scrollbar width to .navbar-fixed-top and .navbar-fixed-bottom before open',
    function (assert) {
      assert.expect(2)
      ...
      $('<div id="modal-test"/>').on('hidden.bs.modal', function () {
        ...
        assert.strictEqual(scrollbarWidth, fixedTopPaddingRight,
          '.navbar-fixed-top has padding-right (' + fixedTopPaddingRight + ') equal to scrollbar width (' +
          scrollbarWidth + ')')

        assert.strictEqual(scrollbarWidth, fixedBottomPaddingRight,
          '.navbar-fixed-bottom has padding-right (' + fixedBottomPaddingRight + ') equal to scrollbar width (' +
          scrollbarWidth + ')')
  ...
  QUnit.test('should restore inline padding-right for .navbar-fixed-top and .navbar-fixed-bottom after close',
    function (assert) {
      assert.expect(2)
      var done = assert.async()
      var $body = $(document.body)
