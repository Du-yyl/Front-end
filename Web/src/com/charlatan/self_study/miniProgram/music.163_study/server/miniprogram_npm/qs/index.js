module.exports = (function () {
    ...
    __DEFINE__(1649750013896, function (require, module, exports) {
        ...
        var map = {
            './stringify': 1649750013897,
            './parse': 1649750013900,
            './formats': 1649750013899,
        }
        return __REQUIRE__(map[modId], modId)
    })
    __DEFINE__(1649750013897, function (require, module, exports) {
        ...
        var map = { './utils': 1649750013898, './formats': 1649750013899 }
        return __REQUIRE__(map[modId], modId)
    })
    __DEFINE__(1649750013898, function (require, module, exports) {
        ...
        var encode = function encode (str, defaultEncoder, charset) {
            ...
            for (var i = 0; i < string.length; ++i) {
                ...
                if (c < 0xD800 || c >= 0xE000) {
                    out = out + (hexTable[0xE0 | (c >> 12)] + hexTable[0x80 | ((c >> 6) & 0x3F)] +
    ...
    __DEFINE__(1649750013899, function (require, module, exports) {
    ...
    __DEFINE__(1649750013900, function (require, module, exports) {
...
// These are the percent-encoded utf-8 octets representing a checkmark, indicating that the request actually is utf-8 encoded.
        ...
        var parseObject = function (chain, val, options) {
            ...
            for (var i = chain.length - 1; i >= 0; --i) {
                ...
                if (root === '[]' && options.parseArrays) {
                    ...
                    var cleanRoot = root.charAt(0) === '[' && root.charAt(root.length - 1) === ']' ? root.slice(1,
                        -1) : root
        ...
        var normalizeParseOptions = function normalizeParseOptions (opts) {
            ...
            return {
                allowDots: typeof opts.allowDots === 'undefined' ? defaults.allowDots : !!opts.allowDots,
                allowPrototypes: typeof opts.allowPrototypes === 'boolean'
                ...
                delimiter: typeof opts.delimiter === 'string' || utils.isRegExp(opts.delimiter)
                    ? opts.delimiter
                    : defaults.delimiter,
                depth: typeof opts.depth === 'number' ? opts.depth : defaults.depth,
                ignoreQueryPrefix: opts.ignoreQueryPrefix === true,
                interpretNumericEntities: typeof opts.interpretNumericEntities === 'boolean'
        ...
        var map = { './utils': 1649750013898 }
        return __REQUIRE__(map[modId], modId)
    })
    return __REQUIRE__(1649750013896)
})()
