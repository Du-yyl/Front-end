module.exports = (function () {
    ...
    __DEFINE__(1649750013812, function (require, module, exports) {
        ...
        function _traverse (
            opts, pre, post, schema, jsonPtr, rootSchema, parentJsonPtr, parentKeyword, parentSchema, keyIndex) {
                    ...
                    if (Array.isArray(sch)) {
                        if (key in traverse.arrayKeywords) {
                            for (var i = 0; i < sch.length; i++)
                                _traverse(opts, pre, post, sch[i], jsonPtr + '/' + key + '/' + i, rootSchema, jsonPtr,
                                    key, schema, i)
                        }
                    } else if (key in traverse.propsKeywords) {
                        if (sch && typeof sch == 'object') {
                            for (var prop in sch)
                                _traverse(opts, pre, post, sch[prop], jsonPtr + '/' + key + '/' + escapeJsonPtr(prop),
    ...
    return __REQUIRE__(1649750013812)
})()
