module.exports = (function () {
    ...
    __DEFINE__(1649750013662, function (require, module, exports) {
        ...
        CombinedStream.prototype.pause = function () {
            ...
            if (this.pauseStreams && this._currentStream && typeof (this._currentStream.pause) ==
                'function') this._currentStream.pause()
            this.emit('pause')
        }
        ...
        CombinedStream.prototype.resume = function () {
            ...
            if (this.pauseStreams && this._currentStream && typeof (this._currentStream.resume) ==
                'function') this._currentStream.resume()
            this.emit('resume')
        }
    ...
    return __REQUIRE__(1649750013662)
})()
