module.exports = (function () {
    ...
    __DEFINE__(1649750013860, function (require, module, exports) {
// Generated by LiveScript 1.6.0
        (function () {
            ...
            VERSION = '0.8.3'
            ref$ = require(
                'prelude-ls'), id = ref$.id, map = ref$.map, compact = ref$.compact, any = ref$.any, groupBy = ref$.groupBy, partition = ref$.partition, chars = ref$.chars, isItNaN = ref$.isItNaN, keys = ref$.keys, Obj = ref$.Obj, camelize = ref$.camelize
            deepIs = require('deep-is')
            ref$ = require(
                './util'), closestString = ref$.closestString, nameToRaw = ref$.nameToRaw, dasherize = ref$.dasherize, naturalJoin = ref$.naturalJoin
            ref$ = require(
                './help'), generateHelp = ref$.generateHelp, generateHelpForOption = ref$.generateHelpForOption
            ...
            main = function (libOptions) {
                        ...
                        if (option.heading == null) {
                            ...
                            if (option.parsedType == null) {
                                ...
                                try {
                                    ...
                                    e = e$
                                    throw new Error(
                                        'Option \'' + name + '\': Error parsing type \'' + option.type + '\': ' +
                                        e.message)
                                }
                            }
                            if (option['default']) {
                                try {
                                    ...
                                    e = e$
                                    throw new Error(
                                        'Option \'' + name + '\': Error parsing default value \'' + option['default'] +
                                        '\' for type \'' + option.type + '\': ' + e.message)
                                }
                            }
                            if (option['enum'] && !option.parsedPossiblities) {
                                ...
                                for (j$ = 0, len1$ = (ref$ = option['enum']).length; j$ < len1$; ++j$) {
                                    ...
                                    try {
                                        ...
                                        e = e$
                                        throw new Error(
                                            'Option \'' + name + '\': Error parsing enum value \'' + possibility +
                                            '\' for type \'' + option.type + '\': ' + e.message)
                                    }
                                }
                            ...
                            if (that = option.dependsOn) {
                                if (that.length) {
                                    ref$ = [].concat(
                                        option.dependsOn), rawDependsType = ref$[0], dependsOpts = slice$.call(ref$, 1)
                            ...
                            if ((!option.aliases || option.shortNames.length === 0) && option.type === 'Boolean' &&
                                option['default'] === 'true') {
                ...
                getOption = function (name) {
                    ...
                    if (opt == null) {
                        ...
                        throw new Error('Invalid option \'' + nameToRaw(name) + '\'' +
                            (possiblyMeant ? ' - perhaps you meant \'' + nameToRaw(possiblyMeant) + '\'?' : '.'))
                    }
                    return opt
                }
                parse = function (input, arg$) {
                    var slice, obj, positional, restPositional, overrideRequired, prop, setValue, setDefaults,
                        checkRequired, mutuallyExclusiveError, checkMutuallyExclusive, checkDependency,
                        checkDependencies, checkProp, args, key, value, option, ref$, i$, len$, arg, that, result,
                        short, argName, usingAssign, val, flags, len, j$, len1$, i, flag, opt, name, valPrime, negated,
                        noedName
                    slice = (arg$ != null
                        ? arg$
                        : {}).slice
                    ...
                    setValue = function (name, value) {
                        ...
                        if (opt.boolean) {
                            ...
                            try {
                                ...
                                if (cra != null && cra[0] && cra[1].oneValuePerFlag && opt.parsedType.length === 1 &&
                                ...
                                e = e$
                                throw new Error(
                                    'Invalid value for option \'' + name + '\' - expected type ' + opt.type +
                            ...
                            if (opt['enum'] && !any(function (it) {
                                ...
                                throw new Error(
                                    'Option ' + name + ': \'' + val + '\' not one of ' + naturalJoin(opt['enum']) + '.')
                            }
                        }
                        currentType = toString$.call(obj[name]).slice(8, -1)
                        if (obj[name] != null) {
                            if (opt.concatRepeatedArrays != null && opt.concatRepeatedArrays[0] && currentType ===
                                'Array') {
                    ...
                    mutuallyExclusiveError = function (first, second) {
                        throw new Error('The options ' + nameToRaw(first) + ' and ' + nameToRaw(second) +
                            ...
                            for (key in input) {
                                ...
                                if (key !== '_') {
                                    ...
                                    if (parsedTypeCheck(option.parsedType, value)) {
                                        ...
                                        throw new Error(
                                            'Option \'' + option.option + '\': Invalid type for \'' + value +
                                            '\' - expected type \'' + option.type + '\'.')
                                    }
                                }
                            }
                                ...
                                if (short) {
                                    ...
                                    for (j$ = 0, len1$ = flags.length; j$ < len1$; ++j$) {
                                        ...
                                        if (restPositional) {
                                            ...
                                            throw new Error('Can\'t set argument \'' + flag +
                                    ...
                                    if (opt.boolean) {
                                        ...
                                        if (negated) {
                                            throw new Error(
                                                'Only use \'no-\' prefix for Boolean options, not with \'' + noedName +
                                                '\'.')
                                        }
                                        if (usingAssign) {
                                            setValue(name, val)
        ...
        var map = { './util': 1649750013861, './help': 1649750013862 }
        return __REQUIRE__(map[modId], modId)
    })
    __DEFINE__(1649750013861, function (require, module, exports) {
// Generated by LiveScript 1.6.0
        (function () {
    ...
    __DEFINE__(1649750013862, function (require, module, exports) {
// Generated by LiveScript 1.6.0
        (function () {
            var ref$, id, find, sort, min, max, map, unlines, nameToRaw, dasherize, naturalJoin, wordWrap, wordwrap,
                getPreText, setHelpStyleDefaults, generateHelpForOption, generateHelp
            ref$ = require(
                'prelude-ls'), id = ref$.id, find = ref$.find, sort = ref$.sort, min = ref$.min, max = ref$.max, map = ref$.map, unlines = ref$.unlines
            ref$ = require(
                './util'), nameToRaw = ref$.nameToRaw, dasherize = ref$.dasherize, naturalJoin = ref$.naturalJoin
            ...
            getPreText = function (option, arg$, maxWidth) {
                var mainName, shortNames, ref$, longNames, type, description, aliasSeparator, typeSeparator,
                    initialIndent, names, namesString, namesStringLen, typeSeparatorString, typeSeparatorStringLen,
                    wrap
                ...
                if (maxWidth != null && !option.boolean && initialIndent + namesStringLen + typeSeparatorStringLen +
                    type.length > maxWidth) {
            ...
            generateHelpForOption = function (getOption, arg$) {
                ...
                return function (optionName) {
                    var maxWidth, wrap, option, e, pre, defaultString, restPositionalString, description,
                        fullDescription, that, preDescription, descriptionString, exampleString, examples, seperator
            ...
            generateHelp = function (arg$) {
                ...
                options = arg$.options, prepend = arg$.prepend, append = arg$.append, helpStyle = (ref$ = arg$.helpStyle) !=
                null
                    ? ref$
                    : {}, stdout = arg$.stdout
                setHelpStyleDefaults(helpStyle)
                ...
                return function (arg$) {
                    var ref$, showHidden, interpolate, maxWidth, output, out, data, optionCount, totalPreLen, preLens,
                        i$, len$, item, that, pre, descParts, desc, preLen, sortedPreLens, maxPreLen, preLenMean, x,
                        padAmount, descSepLen, fullWrapCount, partialWrapCount, descLen, totalLen, initialSpace,
                        wrapAllFull, i, wrap
                    ref$ = arg$ != null
                        ? arg$
                        ...
                        if (item.type === 'heading') {
                            ...
                            if (maxWidth != null) {
                                if (wrapAllFull || wrap === 'full') {
                                    ...
                                    out(initialSpace + '' + pad(pre, padAmount) + descriptionSeparator +
                                        wrap(desc).replace(/^\s+/, ''))
                                    continue
                                }
                            }
        ...
        var map = { './util': 1649750013861 }
        return __REQUIRE__(map[modId], modId)
    })
    return __REQUIRE__(1649750013860)
})()
