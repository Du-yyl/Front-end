module.exports = (function () {
    ...
    __DEFINE__(1649750013777, function (require, module, exports) {
        ...
        var map = { './browser.js': 1649750013778, './node.js': 1649750013780 }
        return __REQUIRE__(map[modId], modId)
    })
    __DEFINE__(1649750013778, function (require, module, exports) {
...
// eslint-disable-next-line complexity
        ...
        function useColors () {
            ...
            return typeof document !== 'undefined' && document.documentElement && document.documentElement.style &&
                ...
                navigator.userAgent.toLowerCase().match(/firefox\/(\d+)/) && parseInt(RegExp.$1, 10) >= 31 || // Double check webkit in userAgent just in case we are in a worker
                typeof navigator !== 'undefined' && navigator.userAgent &&
        ...
        function formatArgs (args) {
            args[0] = (this.useColors ? '%c' : '') + this.namespace + (this.useColors ? ' %c' : ' ') + args[0] +
        ...
        function log () {
            ...
            return (typeof console === 'undefined' ? 'undefined' : _typeof(console)) === 'object' && console.log &&
        ...
        var map = { './common': 1649750013779 }
        return __REQUIRE__(map[modId], modId)
    })
    __DEFINE__(1649750013779, function (require, module, exports) {
    ...
    __DEFINE__(1649750013780, function (require, module, exports) {
    ...
    return __REQUIRE__(1649750013777)
})()
