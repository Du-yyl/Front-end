...
// Backwards compatibility
        ...
        var map = {
            './lib/charset': 1649750013853,
            './lib/encoding': 1649750013854,
            './lib/language': 1649750013855,
            './lib/mediaType': 1649750013856,
        }
        ...
        function specify (type, spec, index) {
            ...
            if (keys.length > 0) {
                if (keys.every(function (k) {
                    return spec.params[k] == '*' || (spec.params[k] || '').toLowerCase() ==
