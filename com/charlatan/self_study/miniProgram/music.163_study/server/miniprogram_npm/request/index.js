module.exports = (function () {
    ...
    __DEFINE__(1649750013919, function (require, module, exports) {
...
// Backwards compatibility for request.debug
        ...
        var map = {
            './lib/cookies': 1649750013920,
            './lib/helpers': 1649750013921,
            './request': 1649750013922,
        }
        return __REQUIRE__(map[modId], modId)
    })
    __DEFINE__(1649750013920, function (require, module, exports) {
...
// Adapt the sometimes-Async api of tough.CookieJar to our requirements
    ...
    __DEFINE__(1649750013921, function (require, module, exports) {
    ...
    __DEFINE__(1649750013922, function (require, module, exports) {
...
// Debugging
        ...
        Request.prototype.init = function (options) {
            ...
            if (!self.uri.port) {
                if (self.uri.protocol === 'http:') { self.uri.port = 80 } else if (self.uri.protocol ===
                    'https:') { self.uri.port = 443 }
            }
            ...
            if (!self.tunnel && self.proxy && self.proxy.auth && !self.hasHeader('proxy-authorization')) {
                var proxyAuthPieces = self.proxy.auth.split(':').
                    map(function (item) { return self._qs.unescape(item) })
        ...
        Request.prototype.getNewAgent = function () {
            ...
            if (self.pool === globalPool && !poolKey && Object.keys(options).length === 0 &&
        ...
        Request.prototype.onRequestResponse = function (response) {
            ...
            if (self.httpModule === https &&
                ...
                var sslErr = response.hasOwnProperty('socket') ? response.socket.authorizationError : self.uri.href +
...
// Exports
        ...
        var map = {
            './lib/helpers': 1649750013921,
            './lib/cookies': 1649750013920,
            './lib/getProxyFromURI': 1649750013923,
            './lib/querystring': 1649750013924,
            './lib/har': 1649750013925,
            './lib/auth': 1649750013926,
            './lib/oauth': 1649750013927,
            './lib/hawk': 1649750013928,
            './lib/multipart': 1649750013929,
            './lib/redirect': 1649750013930,
            './lib/tunnel': 1649750013931,
        }
        return __REQUIRE__(map[modId], modId)
    })
    __DEFINE__(1649750013923, function (require, module, exports) {
    ...
    __DEFINE__(1649750013924, function (require, module, exports) {
        ...
        var map = { 'querystring': 1649750013924 }
        return __REQUIRE__(map[modId], modId)
    })
    __DEFINE__(1649750013925, function (require, module, exports) {
    ...
    __DEFINE__(1649750013926, function (require, module, exports) {
        ...
        var map = { './helpers': 1649750013921 }
        return __REQUIRE__(map[modId], modId)
    })
    __DEFINE__(1649750013927, function (require, module, exports) {
    ...
    __DEFINE__(1649750013928, function (require, module, exports) {
    ...
    __DEFINE__(1649750013929, function (require, module, exports) {
    ...
    __DEFINE__(1649750013930, function (require, module, exports) {
    ...
    __DEFINE__(1649750013931, function (require, module, exports) {
    ...
    return __REQUIRE__(1649750013919)
})()
