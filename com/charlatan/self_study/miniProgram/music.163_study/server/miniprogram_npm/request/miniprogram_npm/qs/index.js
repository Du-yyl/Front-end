module.exports = (function () {
    ...
    __DEFINE__(1649750013914, function (require, module, exports) {
        ...
        var map = {
            './stringify': 1649750013915,
            './parse': 1649750013918,
            './formats': 1649750013917,
        }
        return __REQUIRE__(map[modId], modId)
    })
    __DEFINE__(1649750013915, function (require, module, exports) {
        ...
        module.exports = function (object, opts) {
            ...
            var serializeDate = typeof options.serializeDate === 'function'
                ? options.serializeDate
                : defaults.serializeDate
            var encodeValuesOnly = typeof options.encodeValuesOnly === 'boolean'
        ...
        var map = { './utils': 1649750013916, './formats': 1649750013917 }
        return __REQUIRE__(map[modId], modId)
    })
    __DEFINE__(1649750013916, function (require, module, exports) {
    ...
    __DEFINE__(1649750013917, function (require, module, exports) {
    ...
    __DEFINE__(1649750013918, function (require, module, exports) {
        ...
        var parseObject = function (chain, val, options) {
            ...
            for (var i = chain.length - 1; i >= 0; --i) {
                ...
                if (root === '[]') {
                    ...
                    var cleanRoot = root.charAt(0) === '[' && root.charAt(root.length - 1) === ']'
                        ? root.slice(1, -1)
                        : root
        ...
        module.exports = function (str, opts) {
            ...
            options.delimiter = typeof options.delimiter === 'string' || utils.isRegExp(options.delimiter)
                ? options.delimiter
                : defaults.delimiter
        ...
        var map = { './utils': 1649750013916 }
        return __REQUIRE__(map[modId], modId)
    })
    return __REQUIRE__(1649750013914)
})()
