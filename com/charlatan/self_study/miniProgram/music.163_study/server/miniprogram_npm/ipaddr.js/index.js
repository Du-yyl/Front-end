module.exports = (function () {
    ...
    __DEFINE__(1649750013807, function (require, module, exports) {
        (function () {
            ...
            ipv4Regexes = {
                fourOctet: new RegExp('^' + ipv4Part + '\\.' + ipv4Part + '\\.' + ipv4Part + '\\.' + ipv4Part + '$',
                    'i'),
            ...
            ipaddr.IPv6 = (function () {
                ...
                IPv6.prototype.toRFC5952String = function () {
                    ...
                    return string.substring(0, bestMatchIndex) + '::' +
    ...
    return __REQUIRE__(1649750013807)
})()
