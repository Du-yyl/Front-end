module.exports = (function () {
    ...
    __DEFINE__(1649750013813, function (require, module, exports) {
        /**
        ...
        (function (root, factory) {
            ...
            var validate = exports._validate = function (/*Any*/instance,/*Object*/schema,/*Object*/options) {
                ...
                function checkObj (instance, objTypeDef, path, additionalProp) {
                    ...
                    for (i in instance) {
                        if (instance.hasOwnProperty(i) && !(i.charAt(0) == '_' && i.charAt(1) == '_') && objTypeDef &&
                            !objTypeDef[i] && additionalProp === false) {
                            if (options.filter) {
                                delete instance[i]
                                continue
                            } else {
                        ...
                        if (requires && !(requires in instance)) {
                            errors.push({
                                property: path,
                                message: 'the presence of the property ' + i + ' requires that ' + requires +
                                    ' also be present',
                            })
                        }
                        value = instance[i]
            ...
            exports.mustBeValid = function (result) {
                ...
                if (!result.valid) {
                    throw new TypeError(result.errors.map(
                        function (error) {return 'for property ' + error.property + ': ' + error.message}).
                        join(', \n'))
                }
            }
    ...
    return __REQUIRE__(1649750013813)
})()
