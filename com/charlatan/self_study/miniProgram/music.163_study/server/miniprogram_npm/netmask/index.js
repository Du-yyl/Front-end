module.exports = (function () {
	...
	__DEFINE__ (1649750013857, function (require, module, exports) {
// Generated by CoffeeScript 1.10.0
		(function () {
			...
			Netmask = (function () {
				function Netmask (net, mask) {
					...
					this.last = this.bitmask <= 30 ? long2ip (this.netLong + this.size - 2) : long2ip (
							this.netLong + this.size - 1)
				...
				Netmask.prototype.forEach = function (fn) {
					...
					range = (function () {
						results = []
						for ( var j = ref = ip2long (this.first), ref1 = ip2long (this.last); ref <= ref1
								? j <= ref1
								: j >= ref1; ref <= ref1 ? j++ : j-- ) { results.push (j) }
						return results
					}).apply (this)
					results1 = []
	...
	return __REQUIRE__ (1649750013857)
}) ()
