module.exports = (function () {
    ...
    __DEFINE__(1649750013817, function (require, module, exports) {
        ...
        var map = {
            './decode': 1649750013818,
            './verify': 1649750013819,
            './sign': 1649750013825,
            './lib/JsonWebTokenError': 1649750013820,
            './lib/NotBeforeError': 1649750013821,
            './lib/TokenExpiredError': 1649750013822,
        }
    ...
    __DEFINE__(1649750013819, function (require, module, exports) {
                ...
                if (options.audience) {
                    ...
                    var match = target.some(function (targetAudience) {
                        return audiences.some(function (audience) {
                            return audience instanceof RegExp ? audience.test(targetAudience) : audience ===
                                targetAudience
                        })
                    })
        ...
        var map = {
            ...
            './lib/TokenExpiredError': 1649750013822,
            './decode': 1649750013818,
            './lib/timespan': 1649750013823,
            './lib/psSupported': 1649750013824,
        }
        return __REQUIRE__(map[modId], modId)
    })
    ...
    __DEFINE__(1649750013821, function (require, module, exports) {
        ...
        var map = { './JsonWebTokenError': 1649750013820 }
        return __REQUIRE__(map[modId], modId)
    })
    ...
    __DEFINE__(1649750013825, function (require, module, exports) {
        ...
        var sign_options_schema = {
            expiresIn: {
                isValid: function (value) { return isInteger(value) || (isString(value) && value) },
            ...
            audience: {
                isValid: function (value) { return isString(value) || Array.isArray(value) },
        ...
        var map = { './lib/timespan': 1649750013823, './lib/psSupported': 1649750013824 }
        return __REQUIRE__(map[modId], modId)
    })
