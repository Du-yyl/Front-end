module.exports = (function () {
	...
	__DEFINE__ (1649750013677, function (require, module, exports) {
		...
		var map = { './lib/compat': 1649750013678 }
	...
	__DEFINE__ (1649750013678, function (require, module, exports) {
		...
		var map = { './callsite-tostring': 1649750013679, './event-listener-count': 1649750013680 }
		return __REQUIRE__ (map[modId], modId)
	})
		...
		function callSiteToString (callSite) {
			...
			if ( isMethodCall ) {
				...
				if ( functionName ) {
					...
					if ( methodName && functionName.lastIndexOf ('.' + methodName) !== functionName.length -
							methodName.length - 1 ) {
						line += ' [as ' + methodName + ']'
					}
				} else {
