module.exports = (function () {
	...
	__DEFINE__ (1649750013704, function (require, module, exports) {
		...
		var map = { './lib/express': 1649750013705 }
	...
	__DEFINE__ (1649750013705, function (require, module, exports) {
		...
		removedMiddlewares.forEach (function (name) {
			Object.defineProperty (exports, name, {
				get: function () {
					throw new Error ('Most middleware (like ' + name +
		...
		var map = {
			'./application': 1649750013706,
			'./router/route': 1649750013708,
			'./router': 1649750013707,
			'./request': 1649750013714,
			'./response': 1649750013715,
			'./middleware/query': 1649750013711,
		}
		return __REQUIRE__ (map[modId], modId)
	})
...
// del -> delete alias
	...
	__DEFINE__ (1649750013707, function (require, module, exports) {
		...
		proto.param = function param (name, fn) {
			...
			if ( name[0] === ':' ) {
				deprecate ('router.param(' + JSON.stringify (name) + ', fn): Use router.param(' +
...
// wrap a function
		...
		var map = { './route': 1649750013708, './layer': 1649750013709 }
		return __REQUIRE__ (map[modId], modId)
	})
