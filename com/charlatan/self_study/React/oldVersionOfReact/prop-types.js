(function (f) {
  ...
  return (function e (t, n, r) {
    ...
    1: [
        ...
        module.exports = function (isValidElement, throwOnDirectAccess) {
            ...
            function checkType (isRequired, props, propName, componentName, location, propFullName, secret) {
              ...
              if (props[propName] == null) {
                if (isRequired) {
                  ...
                  return new PropTypeError('The ' + location + ' `' + propFullName + '` is marked as required in ' +
          ...
          function createUnionTypeChecker (arrayOfTypeCheckers) {
            if (!Array.isArray(arrayOfTypeCheckers)) {
              'development' !== 'production' ? printWarning(
          ...
          function createShapeTypeChecker (shapeTypes) {
            function validate (props, propName, componentName, location, propFullName) {
              ...
              var propType = getPropType(propValue)
              if (propType !== 'object') {
                return new PropTypeError('Invalid ' + location + ' `' + propFullName + '` of type `' + propType + '` ' +
      ...
      }, { './checkPropTypes': 1, './lib/ReactPropTypesSecret': 5, 'object-assign': 6, 'react-is': 10 }], 4: [
      function (require, module, exports) {
        /**
         * Copyright (c) 2013-present, Facebook, Inc.
         *
      ...
      }, { './factoryWithThrowingShims': 2, './factoryWithTypeCheckers': 3, 'react-is': 10 }], 5: [
      function (require, module, exports) {
        /**
         * Copyright (c) 2013-present, Facebook, Inc.
         *
...
// nor polyfill, then a plain number is used for performance.
              ...
              function isValidElementType (type) {
                return typeof type === 'string' || typeof type === 'function' ||
                  ...
                  type === REACT_STRICT_MODE_TYPE || type === REACT_SUSPENSE_TYPE || typeof type === 'object' &&
                  type !== null &&
...
// AsyncMode should be deprecated
              function isAsyncMode (object) {
                {
                  if (!hasWarnedAboutDeprecatedIsAsyncMode) {
                    ...
                    lowPriorityWarning$1(false, 'The ReactIs.isAsyncMode() alias has been deprecated, ' +
      ...
      function (require, module, exports) {
        ...
        exports.isValidElementType = function (a) {
          return 'string' === typeof a || 'function' === typeof a || a === e || a === m || a === g || a === f || a ===
            p || 'object' === typeof a && null !== a &&
