...
(function (global, factory) {
				...
				{
					{
						throw Error ('Objects are not valid as a React child (found: ' +
								(childrenString === '[object Object]' ? 'object with keys {' +
										Object.keys (children).join (', ') + '}' : childrenString) +
	...
	function isValidElementType (type) {
		...
		if ( type === exports.Fragment || type === exports.Profiler || type === REACT_DEBUG_TRACING_MODE_TYPE ||
				type === exports.StrictMode || type === exports.Suspense || type === REACT_SUSPENSE_LIST_TYPE ||
		...
		
		{
			if ( unstable_observedBits !== undefined ) {
				error ('useContext() second argument is reserved for future ' +
						'use in React. Passing it is not supported. ' + 'You passed: %s.%s', unstable_observedBits,
	...
	function validateExplicitKey (element, parentType) {
		...
		
		{
			...
			error ('Each child in a list should have a unique "key" prop.' +
					'%s%s See https://reactjs.org/link/warning-keys for more information.', currentComponentErrorInfo,
					childOwner)
	...
	if ( // If Scheduler runs in a non-DOM environment, it falls back to a naive
		...
		if ( typeof console !== 'undefined' ) {
			...
			if ( typeof requestAnimationFrame !== 'function' ) {
				...
				console['error'] (
						'This browser doesn\'t support requestAnimationFrame. ' + 'Make sure that you load a ' +
	...
	var sharedProfilingBuffer =  // $FlowFixMe Flow doesn't know about SharedArrayBuffer
			typeof SharedArrayBuffer === 'function' ? new SharedArrayBuffer (
							profilingStateSize * Int32Array.BYTES_PER_ELEMENT) : // $FlowFixMe Flow doesn't know about ArrayBuffer
					typeof ArrayBuffer === 'function' ? new ArrayBuffer (
							profilingStateSize * Int32Array.BYTES_PER_ELEMENT) : null // Don't crash the init path on IE9
		...
		if ( eventLog !== null ) {
			...
			if ( eventLogIndex + 1 > eventLogSize ) {
				...
				if ( eventLogSize > MAX_EVENT_LOG_SIZE ) {
					// Using console['error'] to evade Babel and ESLint
					console['error'] ('Scheduler Profiling: Event log exceeded maximum size. Don\'t ' +
