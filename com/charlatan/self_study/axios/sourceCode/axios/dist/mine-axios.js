...
//暴露函数 根据响应状态码改变 promise 的状态
    ...
    module.exports = function settle (resolve, reject, response) {
      ...
      if (!validateStatus || validateStatus(response.status)) {
        ...
        reject(
          createError('Request failed with status code ' + response.status, response.config, null, response.request,
            response))
      }
    }
      ...
      var defaults = {
        ...
        transformRequest: [
          function transformRequest (data, headers) {
            ...
            if (utils.isFormData(data) || utils.isArrayBuffer(data) || utils.isBuffer(data) || utils.isStream(data) ||
